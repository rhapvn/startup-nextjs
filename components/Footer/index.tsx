						...
						<div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
							<div className="mb-12 max-w-[360px] lg:mb-16">
								<Link href="/" className={`block w-full py-5 lg:py-2 `}>
									<Image src="/logoMVS.png" alt="logo" width={140} height={30} className="w-full " />
								</Link>

								<p className="pb-9 pl-3 text-base leading-relaxed text-body-color dark:text-body-color-dark">
								...
								<div className="flex flex-col items-start pl-3">
									...
									<p>LVD: 229655</p>
									<p>Mobile: 0433 658 683</p>
									<a
										href="mailto:sales@mobilityvehiclesales.com.au"
										className="text-base text-body-color dark:text-body-color-dark"
									>
										email: sales@mobilityvehiclesales.com.au
									</a>
								</div>
							</div>
						</div>
