...
const Header = () => {
	...
	return (
		<>
			<header
				className={`header left-0 top-0 z-40 flex w-full items-center ${"fixed z-[1000] bg-white !bg-opacity-60 shadow-sticky backdrop-blur-sm transition dark:bg-gray-dark dark:shadow-sticky-dark"}`}
			>
				<div className="container">
					<div className="relative -mx-4 flex items-center justify-between">
						<div className="w-60 max-w-full ">
							<Link href="/" className={`block w-full py-5 lg:py-2 `}>
								<Image src="/logoMVS.png" alt="logo" width={200} height={50} className="w-full " />
							</Link>
						</div>
